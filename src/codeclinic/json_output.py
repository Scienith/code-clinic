...
from .types import ChildEdges, GraphEdges, Modules, ModuleStats


def serialize_to_json(
    modules: Modules, edges: GraphEdges, child_edges: ChildEdges, root_path: str
) -> Dict[str, Any]:
    ...
    child_edges_data = [
        {"parent": parent, "child": child} for parent, child in sorted(child_edges)
    ]
